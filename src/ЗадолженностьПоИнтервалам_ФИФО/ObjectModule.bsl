...
Функция ПолучитьПредопределенныйВариант(Знач Вариант)
	...
	КлючиВариантов.Добавить("ВсяЗадолженностьПоСрокам");
...
Функция СведенияОВнешнейОбработке() Экспорт 
	...
	ПараметрыРегистрации.Вставить("Наименование", 		НСтр("ru = 'Вся задолженность по интервалам (ФИФО) версия 3.3'"));
	ПараметрыРегистрации.Вставить("Версия", 			"3.3");
	ПараметрыРегистрации.Вставить("БезопасныйРежим", 	ИСТИНА);
	ПараметрыРегистрации.Вставить("Информация", 		НСтр("ru = 'Отчет: ""Вся задолженность по интервалам (ФИФО) вер.3.3""'"));
	
	ТаблицаКоманд = ПолучитьТаблицуКоманд();
	
	ДобавитьКоманду(ТаблицаКоманд,
					НСтр("ru = 'Вся задолженность по интервалам (ФИФО) вер.3.3'"),
					"Вся задолженность по интервалам (ФИФО) вер.3.3",
					"ОткрытиеФормы",
					Истина,
					"");
...
Процедура РаспаковкаТекстаЗапроса() Экспорт
	...
	КонецЦикла;
	СхемаКомпоновкиДанных.НаборыДанных.НаборДанных3.Элементы[0].Запрос = Сред(ТекстЗапроса, 1, Разделители[11]) + Рефрены + Сред(ТекстЗапроса, Разделители[12] + 1);
