...
Функция СведенияОВнешнейОбработке() Экспорт 
	...
	ПараметрыРегистрации.Вставить("Наименование", 		НСтр("ru = 'Задолженность ФИФО по интервалам (версия 3.7)'"));
	ПараметрыРегистрации.Вставить("Версия", 			"3.7");
	ПараметрыРегистрации.Вставить("БезопасныйРежим", 	ИСТИНА);
	ПараметрыРегистрации.Вставить("Информация", 		НСтр("ru = 'Отчет: ""Задолженность ФИФО по интервалам (версия 3.7)""'"));
	
	ТаблицаКоманд = ПолучитьТаблицуКоманд();
	
	ДобавитьКоманду(ТаблицаКоманд,
					НСтр("ru = 'Задолженность ФИФО по интервалам (версия 3.7)'"),
					"Задолженность ФИФО по интервалам (версия 3.7)",
					"ОткрытиеФормы",
					Истина,
					"");
